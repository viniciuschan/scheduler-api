...
class AppointmentTestCase(APITransactionTestCase):
    ...
    def test_appointment_list(self):
        ...
        self.assertEqual(response.json(), [
            {
                "id": 1,
                "patient": "http://testserver/patients/7/",
                "procedure": "http://testserver/procedures/7/",
                "date": "2020-10-10",
                "start_at": "15:00:00",
                "end_at": "18:00:00"
            },
            {
                "id": 2,
                "patient": "http://testserver/patients/8/",
                "procedure": "http://testserver/procedures/8/",
                "date": "2021-10-10",
                "start_at": "10:00:00",
                "end_at": "12:00:00"
            }
    ...
    def test_appointment_detail(self):
        ...
        self.assertDictEqual(response.json(), {
                "id": 1,
                "patient": "http://testserver/patients/5/",
                "procedure": "http://testserver/procedures/5/",
                "date": "2020-10-10",
                "start_at": "15:00:00",
                "end_at": "18:00:00"
        })
    ...
    def test_appointment_update(self):
        ...
        payload = {
            "patient": "https://testserver/patients/11/",
            "procedure": "http://testserver/procedures/11/",
            "date": "2021-10-10",
            "start_at": "10:00:00",
            "end_at": "12:00:00"
        }
